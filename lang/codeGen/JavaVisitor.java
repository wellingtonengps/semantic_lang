...
public class JavaVisitor extends Visitor {
    ...
    public JavaVisitor(String fileName, Env<LocalAmbiente<SType>> env, HashMap<String, DataAttributes> datasAttrib) {
        groupTemplate = new STGroupFile("lang/codeGen/templates/java.stg");
